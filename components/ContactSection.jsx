        ...
        <div className="contact-info glass-card">
          ...
          <div className="contact-details">
            ...
            <div className="contact-item">
              ...
              <div><h4>Phone</h4><a href="tel:+918356928772">+91 83569 28772</a></div>
            </div>
            <div className="contact-item">
          ...
          <div className="social-links">
            <a href="https://github.com/pjha91275" target="_blank" rel="noopener noreferrer" className="contact-btn">
            ...
            <a href="https://linkedin.com/in/prince-jha-dev" target="_blank" rel="noopener noreferrer" className="contact-btn">
              <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
